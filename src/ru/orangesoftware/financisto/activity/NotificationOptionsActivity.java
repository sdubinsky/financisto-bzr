	...
	protected void onClick(View v, int id) {
		switch (id) {
			...
			case R.id.notification_vibra: {
				...
				x.select(R.id.notification_vibra, R.string.notification_vibra, adapter, options.vibration.ordinal());
			} break;
			case R.id.notification_led:  {
				ArrayAdapter<String> adapter = EnumUtils.getAdapter(this, colors);
				x.select(R.id.notification_led, R.string.notification_led, adapter, options.ledColor.ordinal());
			} break;
			case R.id.result1: {
